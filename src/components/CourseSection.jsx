...
const courseData = {
   ...
   'All':[ 
        ...
        { level: 'Just Launched', title: 'Portfolio website', description: 'Blending creative design with robust functionality. This portfolio showcases projects where complex challenges were transformed into elegant, high-impact user experiences.', imageSrc: data2, route: 'https://everythingweb.github.io/my-portfolio/' ,githubUrl:'https://github.com/everythingweb/my-portfolio'},
